import{r as N,v as g,o as nt,a as dt,g as L,$ as ut,a0 as pt,a1 as at,O as v,a2 as ft,d as P,a3 as vt,a4 as mt,a5 as j,c as h,l as A,m as _,s as tt,q as n,N as _t,S,e as k,t as V,x as R,a6 as et,p as d,a7 as ht,y as U,a8 as xt,a9 as gt,aa as yt,ab as wt,J as D,ac as bt,Z as Ct,j as x,F as X,A as T,U as $t}from"./index-157ff064.js";import{u as Vt}from"./useForm-dfc30cac.js";const Tt=()=>typeof window>"u",Nt={},b=()=>Tt()?typeof globalThis>"u"?Nt:globalThis:window,St=5,I=N([]),It=e=>{var o;return((o=e.component)==null?void 0:o.props)||{}},kt=e=>e.el?e.el.offsetHeight+St:0,zt=e=>{const o=L(),s=g(()=>{const a=I.value.findIndex(t=>t===o.vnode);return a===-1?0:I.value.slice(a+1).reduce((t,l)=>{const{position:i}=It(l),{position:r}=e;return r===i?kt(l)+t:t},0)});return nt(()=>{I.value.unshift(o.vnode)}),dt(()=>{I.value=I.value.filter(a=>a!==o.vnode)}),{yOffset:s,updateYOffset:()=>{I.value=I.value.filter(a=>a!==o.vnode)}}},Pt=()=>{let e;return{start:(...a)=>(e=window.setTimeout(...a),e),clear:()=>e&&window.clearTimeout(e)}},At=e=>e.startsWith("$t:"),Mt=e=>({type:String,default:e}),ot=(e,o)=>(o&&Object.keys(o).forEach(s=>{e=e.replace(`{${s}}`,String(o[s]))}),e),Ft=()=>{const{globalConfig:e}=ut(),o=g(()=>e.value.i18n);function s(t,l){var i;const r=(i=L())==null?void 0:i.appContext.config.globalProperties.$t;if(typeof r=="function"){const m=r(`vuestic.${t}`,l);if(m)return m}const u=o.value[t];return u?ot(u,l)||t:(pt(`${t} not found in VuesticUI i18n config`),t)}function a(t,l){return t?At(t)?s(t.slice(3),l):ot(t,l)||t:""}return{tp:a,t:s}},Et=(e,o=!1)=>{const{props:s}=L(),{getColor:a,getTextColor:t}=at();return{textColorComputed:g(()=>{if(s.textColor)return a(s.textColor);const i=e?v(e):s.color;if(!i)return"currentColor";const r=a(i);return ft(r)?"currentColor":v(o)?r:a(t(r))})}},Rt=["role","aria-live"],Bt={class:"va-toast__group"},Ot=["textContent"],Ut={class:"va-toast__content"},Lt=["innerHTML"],qt=["textContent"],Ht={key:1,class:"va-toast__content"},Yt=P({name:"VaToast",__name:"VaToast",props:{...vt,title:{type:String,default:""},offsetY:{type:[Number,String],default:16},offsetX:{type:[Number,String],default:16},message:{type:[String,Function],default:""},dangerouslyUseHtmlString:{type:Boolean,default:!1},icon:{type:String,default:"close"},customClass:{type:String,default:""},duration:{type:[Number,String],default:5e3},color:{type:String,default:"primary"},closeable:{type:Boolean,default:!0},onClose:{type:Function},onClick:{type:Function},multiLine:{type:Boolean,default:!1},position:{type:String,default:"top-right",validator:e=>["top-right","top-center","top-left","bottom-right","bottom-center","bottom-left"].includes(e)},render:{type:Function},ariaCloseLabel:Mt("$t:close"),role:{type:String,default:void 0},inline:{type:Boolean,default:!1}},emits:["on-click","on-close"],setup(e,{emit:o}){const s=P({name:"VaToastRenderer",props:{render:{type:Function,required:!0}},setup:f=>()=>f.render()}),{tp:a}=Ft(),t=e,l=o,i=mt(),{getColor:r}=at(),{textColorComputed:u}=Et(g(()=>r(t.color))),m=j("offsetY"),y=j("offsetX"),w=j("duration"),c=N(!1),{yOffset:p,updateYOffset:M}=zt(t),F=g(()=>({vertical:t.position.includes("top")?"top":"bottom",horizontal:t.position.includes("center")?"center":t.position.includes("right")?"right":"left"})),O=()=>{const f=F.value.vertical,$=F.value.horizontal;return $==="center"?{[f]:`${m.value+p.value}px`,left:"50%","--va-toast-x-shift":"-50%"}:{[f]:`${m.value+p.value}px`,[$]:`${y.value}px`}},q=g(()=>[t.customClass,t.multiLine?"va-toast--multiline":"",t.inline?"va-toast--inline":"",[`va-toast--${t.position}`]]),H=g(()=>({...O(),backgroundColor:r(t.color),color:u.value})),E=g(()=>t.role==="status"?"polite":"assertive"),C=g(()=>typeof t.message=="function"?t.message():t.message),J=()=>{var f,$;(f=i.value)==null||f.removeEventListener("transitionend",J),($=i.value)==null||$.remove()},rt=()=>{typeof t.onClick=="function"?t.onClick():l("on-click")},Y=()=>{c.value=!1,M()},it=()=>{typeof t.onClose=="function"?t.onClose():l("on-close"),J()},W=Pt(),Z=W.clear,Q=()=>{w.value>0&&W.start(()=>c.value&&Y(),w.value)};return nt(()=>{c.value=!0,Q()}),(f,$)=>(h(),A(gt,{name:"va-toast-fade",onAfterLeave:it},{default:_(()=>[tt(n("div",{ref_key:"rootElement",ref:i,role:f.$props.role??f.$props.closeable?"alertdialog":"alert","aria-live":E.value,"aria-atomic":"true",class:_t(["va-toast",q.value]),style:S(H.value),onMouseenter:$[0]||($[0]=(...ct)=>v(Z)&&v(Z)(...ct)),onMouseleave:Q,onClick:rt},[n("div",Bt,[f.$props.title?(h(),k("h2",{key:0,class:"va-toast__title",textContent:V(f.$props.title)},null,8,Ot)):R("",!0),tt(n("div",Ut,[f.$props.dangerouslyUseHtmlString?(h(),k("div",{key:0,innerHTML:C.value},null,8,Lt)):(h(),k("p",{key:1,textContent:V(C.value)},null,8,qt))],512),[[et,f.$props.message]]),f.$props.render?(h(),k("div",Ht,[d(v(s),{render:f.$props.render},null,8,["render"])])):R("",!0),f.$props.closeable?(h(),A(ht,{key:2,class:"va-toast__close-icon",role:"button","aria-label":v(a)(f.$props.ariaCloseLabel),tabindex:"0",size:"1rem",name:f.$props.icon,onClick:U(Y,["stop"]),onKeydown:xt(U(Y,["stop"]),["enter"])},null,8,["aria-label","name","onKeydown"])):R("",!0)])],46,Rt),[[et,c.value]])]),_:1}))}}),jt=`:root,
:host {
